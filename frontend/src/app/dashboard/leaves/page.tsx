...
export default function LeavesPage() {
  ...
  const handleDownloadPdf = (recordId: number, userName: string) =>
    downloadFile(`/export/leave/${recordId}`, `Cuti_${sanitizeFileName(userName)}.pdf`, 'pdf');
  const handleDownloadExcel = (recordId: number, userName: string) =>
    downloadFile(`/export/leave/${recordId}/excel`, `Cuti_${sanitizeFileName(userName)}.xlsx`, 'excel');
